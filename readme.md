...
- Users who want to increase their productivity by using voice commands like switch to app_name, open app_name, close that, show desktop, paste x times, undo/redo x times, scroll up/down x times, scroll left/right x times, custom voice commands and macro recording.
...
[![Software Informer Clean Award](https://raw.githubusercontent.com/ProperCode/Work-by-Speech/master/other/awards/si-award-clean.png)](https://work-by-speech.software.informer.com/awards/)
